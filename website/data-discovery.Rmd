...
![Listing Descriptive Stastics](img/listing_table.png){width=70%}
...
![Mergent Intellect Descriptive Stastics](img/MI_table.png){width=80%}
...
![](img/error_table.png){width=80%} ![](img/calculation.png){width=40%}
