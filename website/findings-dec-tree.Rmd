...
To determine if our model reduced the error that Mergent Intellect was making in missclassifying minority owned businesses, we compared the error values before and after the model is applied. This underrepresentation is identified as ‘error’ and represents the proportion of businesses that were falsely classified as non-minority owned. A visualization of this error rate is depicted below. 
