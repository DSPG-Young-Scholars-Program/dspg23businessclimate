...
Because our training and testing sample was small (138 businesses), the model was trained and evaluated 10,000 times. For each sample of 138 companies, we split into a training (70%) and a test (30%) sample.
