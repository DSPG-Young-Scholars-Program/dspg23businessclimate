...
<div class="toc-container">
  ...
  <ul>
[Phase 1](#phase-1-data-discovery-&-aggregation)
[Phase 2](#phase-2:-comparing-our-sources)
[Phase 3](#phase-3:-building-our-training-and-testing-set)
[Phase 4](#phase-4:-model-construction,-training,-and-testing)
[Phase 5](#phase-5:-comparing-results)
...
![Figure 1: A Visual of our Methodology](img/methodology.png)
...
### **Phase 3: Building our Training and Testing Set**
...
![Training Set](img/training2.png)


## **Phase 4: Model Construction, Training, and Testing**


### Introducing Our Predictors
...
![Figure 3: Describing Model Predictors](img/model_predictors.png){width=80%}
...
![Figure 4: Natural Language Processing Models using Executives’ Names](img/nlptable2.png){width=80%}
...
![Figure 7: Confusion Matrix, [Graphic Source]( https://www.kdnuggets.com/2020/04/performance-evaluation-metrics-classification.html)](img/confusionmatrix.png){width=80%}
...
![Figure 8: Evaluation Metric Formulas, [Graphic Source](https://www.tutorialexample.com/an-introduction-to-accuracy-precision-recall-f1-score-in-machine-learning-machine-learning-tutorial/)](img/metricformulas.png){width=80%}

We computed the averages of the measures presented in Figur 8 shown below:

![Figure 9: Model Performance](img/evaluation.png){width=80%}
